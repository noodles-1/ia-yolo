...
parser.add_argument('--epoch_second_stage', dest='epoch_second_stage', type=int, default=100, help='# of epochs')
...
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='./experiments/exp_101/checkpoint/yolov3_test_loss=nan.ckpt-10', help='folder of the training data')
