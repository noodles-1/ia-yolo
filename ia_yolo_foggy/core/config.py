...
parser.add_argument('--epoch_second_stage', dest='epoch_second_stage', type=int, default=60, help='# of epochs')
...
parser.add_argument('--vocfog_traindata_dir', dest='vocfog_traindata_dir', default='../../datasets/lptrain/',
                    help='the dir contains ten levels synthetic foggy images')
parser.add_argument('--vocfog_valdata_dir', dest='vocfog_valdata_dir', default='../../datasets/lpval/',
                    help='the dir contains ten levels synthetic foggy images')
...
parser.add_argument('--test_path', dest='test_path', nargs='*', default='./data/dataset_fog/voc_norm_test.txt', help='folder of the training data')
...
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='./experiments/exp_101/checkpoint/yolov3_test_loss=1.5188.ckpt-60', help='folder of the training data')
